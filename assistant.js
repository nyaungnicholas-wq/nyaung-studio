...
(function () {
  ...
  const KB = [
    ...
    { k: ['work', 'project', 'portfolio', 'built', 'case stud', 'examples', 'shipped'], a: `26 products shipped, 7 live in production. Each has a full write-up on the <a href="work.html">Work</a> page.` },
